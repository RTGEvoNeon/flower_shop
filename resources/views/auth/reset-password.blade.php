<x-guest-layout>
    ...
    <div class="mb-8 text-center">
        <h2 class="text-3xl font-display font-bold text-primary-800 mb-2">Установить новый пароль</h2>
        <p class="text-sage-600 font-light">Введите новый пароль для вашего аккаунта</p>
    </div>
